...
[![Coverage](https://img.shields.io/badge/Python構文カバレッジ-68%25-blue.svg)](#機能ドキュメント)
...
> **カバレッジ**: Python構文機能の68%(75機能)をサポート。変数、演算子、制御フロー、関数、クラス、データ構造、コレクション(list/dict/set)、文字列メソッド、エラー処理など、アルゴリズムプログラミングに必要な基本構造をカバーしています。
...
- **Rust プレビュー** (`Cmd+Shift+T`) - リアルタイムで変換結果を表示
