...
use tsuchinoko::parser::{Program, Stmt, Expr, TypeHint, Param};
use tsuchinoko::semantic::{Type, analyze};
use tsuchinoko::emitter::emit;
use tsuchinoko::ir::{IrNode, IrExpr, IrBinOp};
...
fn test_type_conversions() {
    ...
    assert_eq!(Type::Optional(Box::new(Type::String)).to_rust_string(), "Option<String>");
}
